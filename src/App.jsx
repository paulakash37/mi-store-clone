...
function App() {
    ...
    <Router>
     <PreNavbar/>
         <Navbar />
         <NavOptios miPhones={data?.miPhones} redmiPhones={data?.redmiPhones} tv={data?.tv} 
         laptop={data?.laptop} fitnessAndLifeStyle={data?.fitnessAndLifeStyle}
      ...
      <Route exact path="/music" element={ <HotAccessories music={data.hotAccessories.music}
       musicCover={data.hotAccessoriesCover.music}  />}/>
     
    

       <Route exact path="/smartDevice" element={<HotAccessories smartDevice={data.hotAccessories.smartDevice} 
       smartDeviceCover={data.hotAccessoriesC}/>}/>
